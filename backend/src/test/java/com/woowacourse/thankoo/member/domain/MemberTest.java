...
class MemberTest {
    ...
    void createWithInvalidNameException(String name) {
        assertThatThrownBy(() -> new Member(name, HUNI_EMAIL, HUNI_SOCIAL_ID, IMAGE_URL_SKRR))
    ...
    void createWithInvalidEmailException(String email) {
        assertThatThrownBy(() -> new Member(HUNI_NAME, email, HUNI_SOCIAL_ID, IMAGE_URL_SKRR))
                .isInstanceOf(InvalidMemberException.class)
    ...
    @Test
    void hasSameId() {
        Member member = new Member(1L, HUNI_NAME, HUNI_EMAIL, HUNI_SOCIAL_ID, IMAGE_URL_SKRR);
    ...
    class UpdateNameTest {
        ...
        @Test
        void updateName() {
            Member member = new Member(HUNI_NAME, HUNI_EMAIL, HUNI_SOCIAL_ID, IMAGE_URL_SKRR);
