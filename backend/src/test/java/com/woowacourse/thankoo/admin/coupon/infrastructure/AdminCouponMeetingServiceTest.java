...
@DisplayName("AdminCouponMeetingService 는 ")
@ApplicationTest
class AdminCouponMeetingServiceTest {

    @Autowired
    private AdminCouponMeetingService adminCouponMeetingService;
    ...
    void update() {
        ...
        adminCouponMeetingService.finishMeetings(List.of(coffeeCoupon, mealCoupon));
