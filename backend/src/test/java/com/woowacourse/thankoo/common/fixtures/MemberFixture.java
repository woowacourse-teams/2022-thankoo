...
public class MemberFixture {
    ...
    public static final String HUNI_SOCIAL_ID = "1";
    public static final String LALA_SOCIAL_ID = "2";
    public static final String SKRR_SOCIAL_ID = "3";
    public static final String HOHO_SOCIAL_ID = "4";
