...
class ReservationServiceTest {
    ...
    void getReceivedReservations() {
        ...
        List<ReservationResponse> reservations = reservationService.getReceivedReservations(sender.getId());
    ...
    void getSentReservations() {
        ...
        List<ReservationResponse> reservations = reservationService.getSentReservations(receiver.getId());
