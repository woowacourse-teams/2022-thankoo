...
class ReservationTest {
    ...
    class UpdateTest {
        ...
        void updateMemberNotMatchException() {
            ...
            assertThatThrownBy(
                    () -> reservation.update(
                            new Member(receiverId, LALA_NAME, LALA_EMAIL, LALA_SOCIAL_ID, SKRR_IMAGE_URL),
        ...
        void updateCouponStatusException() {
            ...
            assertThatThrownBy(
                    () -> reservation.update(
                            new Member(huni.getId(), LALA_NAME, LALA_EMAIL, LALA_SOCIAL_ID, SKRR_IMAGE_URL),
                            ReservationStatus.ACCEPT,
                            new FakeReservedMeetingCreator()))
                    .isInstanceOf(InvalidReservationException.class)
                    .hasMessage("예약 상태를 변경할 수 없습니다.");
        ...
        void update() {
            ...
            reservation.update(new Member(senderId, LALA_NAME, LALA_EMAIL, LALA_SOCIAL_ID, SKRR_IMAGE_URL),
                    ReservationStatus.ACCEPT,
                    new FakeReservedMeetingCreator());
